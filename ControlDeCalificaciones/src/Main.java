...
public class Main {
    public static void main(String[] args) {
        ...
        Reporte reporteEstudiante = new Reporte();
        String nombre = InputValidator.leerTextoNoVacio(scanner, "Ingresa tu nombre");
        double parcial1 = InputValidator.leerDoubleEnRango(scanner, "Ingresa la calificacion del primer parcial", 0, 100);
        ...
        reporteEstudiante.procesar(parcial1, parcial2, parcial3, asistencia, promedioFinal, entregoProyecto);
        reporteEstudiante.imprimirReporte(nombre,parcial1, parcial2, parcial3, asistencia, entregoProyecto);
